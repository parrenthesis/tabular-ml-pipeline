...
def test_main_smoke():
    ...
    try:
        run_pipeline(db_path="data/data.db", model="rf", output_dir=test_output_dir, log_dir=test_log_dir)
        assert (pathlib.Path(test_output_dir) / "feature_importances_RandomForest.png").exists()
...
def test_main_cli_entrypoint():
    ...
    result = subprocess.run([
        ...
        '--model', 'rf',
        '--output-dir', 'test_outputs_cli',
        '--log-dir', 'test_logs_cli'
